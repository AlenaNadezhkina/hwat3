...
public class CardTest {
    ...
    @Test
public void shouldSuccessfulSubmission() {
    ...
    @Test
    public void shouldUnsuccessfulInvalildName() {
...
@Test
public void shouldUnsuccessfulInvalildPhone() {
    driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Иванов Иван");
    driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("9990000000");
    driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
    driver.findElement(By.cssSelector("button")).click();
